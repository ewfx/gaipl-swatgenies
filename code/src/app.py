...
from agentic_chatbot import LLMAGENT
LLMAGENT = LLMAGENT()
...
def chatbot_response(user_message, chatbot_history, dropdown_value, search_mode):
    ...
    bot_response = LLMAGENT.run_genai_agent(user_message, df_incident_filtered, dropdown_value, active_metrics)
...
def chatbot_response(user_message, chatbot_history, dropdown_value, search_mode):
    ...
    if chatbot_history is not None:  # Ensure chatbot_history is initialized
        chatbot_history = []
